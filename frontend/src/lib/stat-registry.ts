...
export type WidgetType = 'positional_bar' | 'response_distribution' | 'range_heatmap' | 'trend_sparkline';
...
const REGISTRY: Record<string, StatRegistryEntry> = {
  // Preflop action
  vpip:              { displayName: 'VPIP',              heroStatsField: 'vpip',              isPositional: true,  widgets: ['range_heatmap', 'trend_sparkline'] },
  pfr:               { displayName: 'PFR',               heroStatsField: 'pfr',               isPositional: true,  widgets: ['range_heatmap', 'trend_sparkline'] },
  open_raise:        { displayName: 'Open Raise',        heroStatsField: 'open_raise',        isPositional: true,  widgets: ['range_heatmap', 'trend_sparkline'] },
  call_open_raise:   { displayName: 'Call Open Raise',   heroStatsField: 'call_open_raise',   isPositional: true,  widgets: ['range_heatmap', 'trend_sparkline'] },
  three_bet:         { displayName: '3-Bet',             heroStatsField: 'three_bet',         isPositional: true,  widgets: ['range_heatmap', 'trend_sparkline'] },
  three_bet_ip:      { displayName: '3-Bet IP',          heroStatsField: 'three_bet_ip',      isPositional: true,  widgets: ['range_heatmap', 'trend_sparkline'] },
  three_bet_oop:     { displayName: '3-Bet OOP',         heroStatsField: 'three_bet_oop',     isPositional: true,  widgets: ['range_heatmap', 'trend_sparkline'] },
  four_bet:          { displayName: '4-Bet',             heroStatsField: 'four_bet',          isPositional: true,  widgets: ['range_heatmap', 'trend_sparkline'] },
  five_bet:          { displayName: '5-Bet',             heroStatsField: 'five_bet',          isPositional: false, widgets: ['trend_sparkline'] },
  // Preflop defense
  fold_to_3bet:      { displayName: 'Fold to 3-Bet',    heroStatsField: 'fold_to_3bet',      isPositional: true,  widgets: ['response_distribution', 'range_heatmap', 'trend_sparkline'] },
  fold_to_4bet:      { displayName: 'Fold to 4-Bet',    heroStatsField: 'fold_to_4bet',      isPositional: true,  widgets: ['response_distribution', 'range_heatmap', 'trend_sparkline'] },
  limp:              { displayName: 'Limp',              heroStatsField: 'limp',              isPositional: true,  widgets: ['range_heatmap', 'trend_sparkline'] },
  squeeze:           { displayName: 'Squeeze',           heroStatsField: 'squeeze',           isPositional: false, widgets: ['trend_sparkline'] },
  limp_fold:         { displayName: 'Limp-Fold',         heroStatsField: 'limp_fold',         isPositional: false, widgets: ['trend_sparkline'] },
  four_bet_fold:     { displayName: '4-Bet-Fold',        heroStatsField: 'four_bet_fold',     isPositional: false, widgets: ['trend_sparkline'] },
  call_4bet:         { displayName: 'Call 4-Bet',        heroStatsField: 'call_4bet',         isPositional: false, widgets: ['trend_sparkline'] },
